# Available .DAD One-Word Domains (22,942)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-1%2C000%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-22%2C942%20domains-6f42c1">
...
> The full live catalog for this exact search currently contains **22,942 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 22,942 domains · **Median ask:** $62.53 · **High-demand under $2,500:** 34
...
| --------- | --------- | --------- | ------------- | -------------- | ------ | ------ | --------- |
| clean.dad | premium   | $311.25   | —             | high           | low    | 5      | name.com  |
...
| buy.dad   | premium   | $1,298.70 | $1,298.70     | medium         | medium | 3      | namecheap |
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 22,942 live domains                        |
...
> Unique Domains. *Available .DAD One-Word Domains*. Version 2026-09-11. Public GitHub extract for the exact Unique Domains search represented by this repository.
